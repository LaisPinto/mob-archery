...
import 'package:mob_archery/app/modules/auth/models/user_model.dart';
import 'package:mob_archery/app/modules/auth/stores/auth_state.dart';
import 'package:mob_archery/app/modules/profile/enums/measurement_unit.dart';
...
class ProfileAction {
  ...
  Future<void> updateAccountData({
    ...
    try {
      ...
      runInAction(() {
        authState.userProfile = updatedUser;
      ...
      runInAction(
        () => state.successMessage.value = 'Account data updated successfully.',
      );
